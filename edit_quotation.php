...
if (!empty($_POST['companyName']) && $_POST['companyName'] && !empty($_POST['invoiceId']) && $_POST['invoiceId']) {
	$invoice->updateQuotation($_POST);
	header("Location:quotation_list.php");
}
if (!empty($_GET['update_id']) && $_GET['update_id']) {
	$invoiceValues = $invoice->getQuotation($_GET['update_id']);
	$invoiceItems = $invoice->getQuotationItems($_GET['update_id']);
}
?>
<title>Invoice System | Edit Quotation</title>
				...
				<div class="load-animate animated fadeInUp">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							...
							<div class="form-group">
								<input value="<?php echo $invoiceValues['name']; ?>" list="customer" class="form-control companyName" name="companyName" id="companyName" placeholder="Company Name" autocomplete="off">
							...
							<div class="form-group">
								<textarea class="form-control address" rows="2" name="address" id="address" placeholder="Your Address"><?php echo $invoiceValues['address']; ?></textarea>
							</div>
							<div class="row">
								<div class="col">
									<div class="form-group">
										<input type="text" class="form-control ntn" name="ntn" id="ntn" placeholder="NTN" autocomplete="off" value="<?php echo $invoiceValues['ntn']; ?>">
									</div>
								</div>
								<div class="col">
									<div class="form-group">
										<input type="text" class="form-control strn" name="strn" id="strn" placeholder="STRN" autocomplete="off" value="<?php echo $invoiceValues['strn']; ?>">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row justify-content-center">
						<div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
							<div class="form-group">
								<input type="text" class="form-control" name="title" id="title" placeholder="Title" autocomplete="off" value="<?php echo $invoiceValues['title']; ?>">
							</div>
						</div>
					</div>
					<div class="row">
							...
							<table class="table table-condensed table-striped" id="invoiceItem">
								...
								?>
									<tr>
										...
										<td><input type="text" value="<?php echo $invoiceItem["item_code"]; ?>" name="productCode[]" id="productCode_<?php echo $count; ?>" class="form-control item_id" autocomplete="off"></td>
										<td>
											<input list="item_list_<?php echo $count; ?>" value="<?php echo $invoiceItem["item_name"]; ?>" name="productName[]" id="productName_<?php echo $count; ?>" data-id="<?php echo $count; ?>" class="form-control item_name" autocomplete="off">
											<datalist id="item_list_<?php echo $count; ?>">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
							...
							<div class="form-group">
								...
								<input data-loading-text="Updating Quotation..." type="submit" name="invoice_btn" value="Update Quotation" class="btn btn-success submit_btn invoice-save-btm">
							</div>
