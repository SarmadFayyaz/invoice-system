...
if (!empty($_POST['companyName']) && $_POST['companyName']) {
   $invoice->saveQuotation($_POST);
   header("Location:quotation_list.php");
}
?>
<title>Invoice System | Create Quotation </title>
               ...
               <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                     ...
                     <div class="form-group">
                        ...
                        <input data-loading-text="Saving Quotation..." type="submit" name="invoice_btn" value="Save Quotation" class="btn btn-success submit_btn invoice-save-btm">
                     </div>
                  </div>
               </div>
