...
?>
<title>Invoice System | Invoice List</title>
  ...
  <table id="data-table" class="table table-condensed table-striped">
    ...
    foreach ($invoiceList as $invoiceDetails) {
      ...
      echo '
        ...
        <td><a href="print_invoice.php?invoice_id=' . $invoiceDetails["order_id"] . '" target="_blank" title="Print Invoice"><i class="fas fa-print"></i></a></td>
